...
- `02a_demo_virtual_stage.ipynb`: Shows how to create a virtual (simulated) Enderscope stage without physical hardware.
- `02b_import_xyz_as_history.ipynb`: Shows how to load a list of (x, y, z) coordinates into a virtual stage's position history.
...
- `11_demo_smart_scanning.ipynb`: Demonstrates a smart scanning workflow that locates sample positions before capturing images.
- `12_image_calibration.ipynb`: Walks through calibrating stage movement against captured image coordinates.
